    ...
    renderUserList() {
        ...
        return `
            <div class="bg-white p-6 md:p-8 rounded-2xl shadow-md">
                ...
                <div class="mt-4">
                    <input type="text" id="user-search-input" placeholder="Cari nama atau username..." class="w-full bg-slate-50 border p-3 rounded-xl text-xs font-bold outline-none focus:ring-2 focus:ring-teal-500">
                </div>
